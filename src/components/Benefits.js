    ...
    >
      ...
      <g filter="url(#bbblurry-filter)">
        ...
        <div className="lg:w-2/5 w-full lg:text-start text-center lg:h-full  benefits-1 flex justify-center lg:items-center lg:px-24 px-8">
            <h1 data-aos="fade-up" className='text-black font-visita-bold lg:text-7xl text-2xl mt-8  lg:mt-0' ><span className='text-primary' >Benefits</span> Of Digital Visiting Card</h1>
        </div>

        <div className="flex-1  h-full benefits-2 flex flex-col lg:justify-center lg:items-start items-center lg:pt-0 pt-8 lg:px-0 px-4">
            <div data-aos="fade-up" data-aos-delay="200" className="w-full h-12 flex items-center lg:-ml-0 -ml-12">
                <img src="../assets/images/normal/tick.jpg" className='w-24 h-14'  />
            ...
            <div data-aos="fade-up" data-aos-delay="300" className="w-full h-12 mt-4 lg:mt-2 flex items-center lg:-ml-0 -ml-12">
                <img src="../assets/images/normal/tick.jpg" className='w-24 h-14'  />
                <h1 className='font-visita-medium lg:text-lg text-xs -ml-4  text-black' >There is no need for printing or stock maintenance.</h1>
            </div>
            <div data-aos="fade-up" data-aos-delay="400" className="w-full h-12 mt-4 lg:mt-2 flex items-center lg:-ml-0 -ml-12">
                <img src="../assets/images/normal/tick.jpg" className='w-24 h-14'  />
            ...
            <div data-aos="fade-up" data-aos-delay="500" className="w-full h-12 mt-4 lg:mt-2 flex items-center lg:-ml-0 -ml-12">
                <img src="../assets/images/normal/tick.jpg" className='w-24 h-14'  />
            ...
            <div data-aos="fade-up" data-aos-delay="600" className="w-full h-12 mt-4 lg:mt-2 flex items-center lg:-ml-0 -ml-12">
                <img src="../assets/images/normal/tick.jpg" className='w-24 h-14'  />
            ...
            <div data-aos="fade-up" data-aos-delay="700" className="w-full h-12 mt-4 lg:mt-2 flex items-center lg:-ml-0 -ml-12">
                <img src="../assets/images/normal/tick.jpg" className='w-24 h-14'  />
            ...
            <div data-aos="fade-up" data-aos-delay="800" className="w-full h-12 mt-4 lg:mt-2 flex items-center lg:-ml-0 -ml-12">
                <img src="../assets/images/normal/tick.jpg" className='w-24 h-14'  />
            ...
            <div data-aos="fade-up" data-aos-delay="900" className="w-full h-12 mt-4 lg:mt-2 flex items-center lg:-ml-0 -ml-12">
                <img src="../assets/images/normal/tick.jpg" className='w-24 h-14'  />
