  ...
  return (
    ...
    >
      ...
      <div className="flex lg:flex-row flex-col items-center w-full h-full mt-8">
        <div  data-aos-delay="100" className="w-full h-full  flex lg:mt-auto  flex-col lg:items-center items-start">
        ...
        <div  data-aos-delay="200" className="w-full h-full  flex lg:mt-auto mt-16 flex-col lg:items-center items-start">
          <div className="flex w-full lg:justify-center ">
            <img
        ...
        <div  data-aos-delay="300" className="w-full h-full  flex lg:mt-auto mt-16 flex-col lg:items-center items-start">
          <div className="flex w-full lg:justify-center ">
            <img
