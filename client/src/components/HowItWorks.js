  ...
  return (
    ...
    >
      ...
      <div className="w-full z-20 lg:py-4 flex flex-col lg:items-center">
        ...
        <p data-aos="fade-up"
            data-aos-delay="0" className="lg:mt-14 mt-8 lg:text-[2.25rem] text-[1.125rem] lg:text-center w-[900px]" >Visita is a website builder <br className="lg:hidden block"  /> that lets businesses easily create <br className="lg:hidden block"  /> a professional website in under <br className="lg:hidden block"  /> 10 minutes <br className="lg:hidden block"  /> without needing developers.</p>
      </div> 
