    ...
    >
      ...
      <g filter="url(#bbblurry-filter)">
        ...
        <div className="lg:w-2/5 w-full lg:text-start text-center lg:h-full  benefits-1 flex justify-center lg:items-center lg:px-24 px-8">
            <h1  className='text-black font-visita-bold lg:text-7xl text-3xl mt-8  lg:mt-0' ><span className='text-primary' >Benefits</span> Of Digital Visiting Card</h1>
        </div>
        ...
        <div className="flex-1  h-full benefits-2 flex flex-col lg:justify-center lg:items-start items-center lg:pt-0 pt-8 lg:px-12 px-4">
            ...
            <div   className="w-full h-12 mt-10 lg:mt-2 flex items-center lg:-ml-0 -ml-12">
               <span className='text-green-500 lg:text-3xl text-2xl lg:mr-8 mr-6  ml-8 lg:-ml-8'><ion-icon name="checkmark"></ion-icon></span>
