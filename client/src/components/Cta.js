...
function Cta() {
  ...
  return (
    <div className="w-full flex flex-col lg:h-[1150px] bg-black relative">
      <div className="w-full z-20 lg:py-10 flex flex-col items-center">
        ...
        <p data-aos="fade-up" data-aos-delay="50" className="mt-6 lg:text-[1.70rem] text-[1.10rem] text-center lg:w-[700px] font-semibold text-white" >Design and publish your first <br /> site with Visita today.</p>
      </div>
      ...
      <div className="flex lg:flex-row flex-col lg:px-0 px-10 w-full  mt-6 justify-center">
        ...
        <div data-aos="fade-up" data-aos-delay="250" className=" overflow-hidden lg:py-0 py-6  lg:text-start text-center lg:h-full  benefits-1 lg:flex hidden justify-center lg:items-center lg:px-24 px-8 mt-16">
        <img
        
          className="   rounded-3xl h-[700px] lg:min-w-[1000px]"
      ...
      <div className="h-[130px] lg:block hidden blur-lg w-full bg-black absolute bottom-[180px] z-20"></div>
