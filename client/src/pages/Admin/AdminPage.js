...
function AdminPage() {
  ...
  franchisees &&
    franchisees.map((data) => {
      total_expence +=
        parseInt(data.created_cards_total) * profit_for_franchisee;
    });
  createdCards &&
          ...
          <TabPanel>
            <div className="w-full py-6  flex items-center flex-wrap justify-center px-3">
              ...
              <div className="w-[300px] h-[200px] border rounded-3xl mx-4 my-4 flex flex-col items-center justify-center">
                ...
                <h1 className="text-5xl text-purple-600 mt-4">
                  ₹
                  {earnings_from_franchisee_creation
                    .toString()
                    .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                </h1>
              </div>
            ...
            <form class="flex items-center mt-6">
              ...
              <div class="relative w-full">
                ...
                <input
                  ...
                  id="simple-search"
                  class="bg-gray-50 border border-gray-profit_for_franchisee text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  :bg-gray-700 :border-gray-card_price :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500"
                    ...
                    return (
                      <div className="w-full pl-12 min-h-[64px] border border-purple-100 rounded-xl shadow-sm shadow-black/5 flex items-center mt-4">
                        ...
                        <div className="flex-1  h-full  flex justify-end items-center pr-12">
                          <h1
                            onClick={() => window.open("/" + data.clean_name)}
                            className=" flex items-center justify-center text-2xl mr-4 cursor-pointer -rotate-45 text-[#6635E3]"
                          >
                          ...
                          {data.franchisee_email != "no franchisee" ? (
                            <Tooltip
                              ...
                              label={
                                franchisees &&
                                franchisees.map((franchisee_data) => {
                                  let franchisee_id;
                                  if (
                                    franchisee_data.email ==
                                    data.franchisee_email
                                  ) {
                                    franchisee_id =
                                      franchisee_data.franchisee_id;
                                  }
            ...
            <form class="flex items-center mt-6">
              ...
              <div class="relative w-full">
                ...
                <input
                  ...
                  id="simple-search"
                  class="bg-gray-50 border border-gray-profit_for_franchisee text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  :bg-gray-700 :border-gray-card_price :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500"
                  placeholder="Search By Franchisee Id"
                  required
                />
              </div>
            </form>
              ...
              {franchisees &&
                franchisees
                  ...
                  .map((data, index) => {
                    return (
                      <div
                        className={`w-[350px] relative h-[350px] border ${
                          index == 0 ? "border-purple-600" : ""
                        }  rounded-3xl mx-4 my-4 flex flex-col items-center justify-center`}
                      >
                        ...
                        <span class="cursor-pointer bg-purple-100 text-purple-800 text-xl font-medium  px-2.5 py-0.5 rounded-full :bg-purple-200 :text-purple-800 mt-6">
                          {data.upi_id}
                        </span>

                        <h1 className="text-4xl text-purple-600 mt-4">
                          ₹
                          {data.created_cards_thismonth * profit_for_franchisee}
                        </h1>

                        <button
                          onClick={() => handleSalaryPayedClick(data.email)}
                          class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-profit_for_franchisee font-medium rounded-full text-xl px-5 mt-6 py-2.5 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
                        >
                          Salary Payed
                        </button>
                      </div>
