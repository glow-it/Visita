...
return(
    ...
    <h1 onClick={()=> window.open('/' + data.clean_name)} className=' flex items-center justify-center text-2xl mr-4 cursor-pointer -rotate-45 text-[#6635E3]' ><ion-icon name="arrow-forward-circle"></ion-icon></h1>
