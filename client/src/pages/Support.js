...
function Support() {
    ...
    <div className=" w-full bg-white flex flex-col items-center overflow-scroll pb-56">
      ...
      <div className="w-full h-72  flex pt-36 flex-col items-center justify-center lg:px-0 px-8">
        <h1
          data-aos="fade-up"
          data-aos-delay="0"
          className="font-extrabold lg:text-[4.25rem] text-4xl text-center"
        >
      ...
      <div
        data-aos="fade-up"
        data-aos-delay="200"
        className="lg:w-[75%] w-[95%]  z-40 rounded-2xl h-[500px] bg-white shadow-lg flex lg:flex-row flex-col mt-16"
      >
        <div className="lg:w-[35%] lg:pb-0 pb-12 w-full px-16 lg:rounded-l-2xl rounded-t-2xl bg-[#712FFE] flex flex-col items-center pt-16">
          <img
            src="https://assets.website-files.com/632b3351e816b66faf6d72ce/6373d0a36705627b7335c66a_Group%20488082.png"
            className=""
          />
          <h3 className="text-white mt-10 font-bold text-2xl text-center">
            I Like Assistance the have Platform
          </h3>
          <button
            onClick={() => {
            ...
            className="font-semibold mb-4 text-lg py-4 w-full rounded-lg mt-6 bg-white text-[#712FFE]"
          >
            Chat with us
          </button>
        ...
        <div className="lg:w-[65%] w-full lg:rounded-2xl bg-white flex flex-col  lg:px-12 px-4">
          ...
          <div className="w-full   flex flex-wrap mt-2">
            <input
              autoComplete="off"
              className="font-medium focus:border focus:border-[#712FFE] border py-3.5 pl-4 lg:w-[48%] w-full mr-3 mt-3 rounded-md"
            ...
            <textarea
              autoComplete="off"
              className="font-medium w-full border-slate-200 focus:border-1 focus:border-[#712FFE] border py-3.5 h-32 pl-4 mr-3 mt-3 rounded-md"
              id="contact_message"
              placeholder="Message"
            />
          </div>
  ...
  `;
              ...
              className="font-semibold mb-4 h-16 justify-center flex items-center text-lg py-4 w-full rounded-lg  bg-black text-white"
            >
              Send message
            </button>
          </div>
