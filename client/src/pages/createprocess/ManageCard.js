    ...
    <div className="flex flex-col items-center pb-28">
      ...
      {localStorage.getItem("isAdmin") != "true" ? (
        <div
          ...
          className="h-screen  w-full absolute font-medium bg-slate-50 z-[100] flex pt-36 justify-center"
        >
      ...
      <h1 className="text-4xl font-bold mb-10 mt-16 capitalize">
      ...
      <div className="py-6 w-full flex lg:flex-row flex-col items-center justify-center  z-50">
        <button
          onClick={onOpen}
          className="px-6 py-2 mr-3 lg:mt-0   hover:bg-red-500 hover:text-white transition-colors bg-slate-50 border-2 border-red-500 text-red-500 rounded-3xl  font-bold"
        >
          <i class="fa-solid mr-1 fa-circle-xmark"></i> Close website
        </button>
        ...
        {cardDatas && cardDatas.show_customer_details_popop == "true" ? (
          ...
          >
            <ion-icon name="newspaper-outline"></ion-icon> Customer details
          </button>
        ) : (
          ""
        )}
      ...
      <div className="z-50 flex flex-col items-center">
        ...
        <button
          ...
          className="px-6 mt-4 cursor-pointer py-2 bg-blue-600 border-2 border-blue-600 text-white rounded-3xl  font-bold"
        >
          Go To Details Page
        </button>
      </div>
