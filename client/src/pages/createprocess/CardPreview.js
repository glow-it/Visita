...
function CardPreview() {
  ...
  return (
    <div className='h-screen w-full ' >
        ...
        {/* <div className="h-screen w-full -ml-6 z-50 bg-white  absolute card-preview-successfull-animation flex items-center justify-center">
        <div className="w-[800px] -mt-16">
        <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_jbrw3hcz.json"  background="transparent"  speed="1" autoplay></lottie-player>
        </div>
        </div> */}
