...
<form id="otp_email_send_form" className="hidden">
          ...
          <div class="w-full ">
            <div class="bg-white overflow-hidden relative shadow-md h-[450px] flex flex-col justify-center py-3 rounded-3xl text-center">
              ...
              <div className="forgot_franchisee_password_successfull h-full z-50 absolute w-full rounded-3xl bg-white hidden flex-col items-center  pt-24">
                ...
                <span className="mt-4 font-medium mb-1" >Your Franchisee Password Is</span>
                <span className="mt-2 font-bold py-1.5 px-6 bg-green-100 text-green-600 rounded-full" >{franchiseeDatas && franchiseeDatas.password}</span>
              </div>
  ...
  speed='0.5s' />
                    ...
                    <div id='send_otp_button_wrapper' className="flex">
                       <button onClick={()=> sendOTP()} className="border border-purple-600 transition-transform  font-bold rounded-full px-6 py-2 text-purple-600 hover:scale-105 mt-4 text-md">
                    send OTP
                </button>
                ...
                <button onClick={()=> window.location.reload()} className="border border-purple-600 transition-transform  font-bold rounded-full px-6 py-2 text-purple-600 hover:scale-105 mt-24 text-md">
                    Try again
                </button>
              ...
              <button onClick={()=> verifyOtp()} className="bg-purple-600 transition-colors mb-4 mt-8 font-bold rounded-full px-6 py-2 text-white hover:bg-purple-800 text-xl">
                    Verify Otp
                </button>

               {
                ...
                <a id="forgot_franchisee_password_resend_otp_button" class="hidden font-bold items-center text-purple-600 hover:text-purple-900 cursor-pointer">
