  ...
  <div class="grid max-w-screen-md gap-10 md:grid-cols-2 sm:mx-auto">
    <div data-aos="fade-up" data-aos-delay="200" >
      <div class="p-8 bg-gray-900 rounded">
        ...
        <button
        onClick={()=> navigate('/create',{state:{franchisee:location.state.franchisee,franchisee_email:location.state.franchisee_email,isPremium:false}})} 
    ...
    <div data-aos="fade-up" data-aos-delay="300" >
      <div class="p-8 bg-gray-900 rounded">
        ...
        <button
        onClick={()=> navigate('/create',{state:{franchisee:location.state.franchisee,franchisee_email:location.state.franchisee_email,isPremium:true}})} 
