  ...
  return (
    <div >
...

         {
            ...
            <div id='franchisee_top_information' className="h-10 w-full bg-green-100 border border-green-800 text-green-800 flex items-center justify-center relative">
            ...
            <div className="text-green-800 absolute justify-center h-full flex items-center right-8">
    ...
    <TabPanel>
        <div className="w-full flex flex-col">
            <div className="w-full  flex-wrap flex items-center justify-center">
                <div className="w-[320px] h-56 border border-purple-600 bg-purple-100 text-purple-800 flex flex-col items-center justify-center rounded-3xl lg:mr-12 lg:mb-0 mb-6">
                    <h2 className='-mt-6' >My earnings</h2>
                    <h1  className=' text-5xl mt-3 text-purple-800' >₹{earnings_this_month}</h1>
                </div>
                <div className="w-[320px] h-56 border border-purple-600 bg-purple-100 text-purple-800 flex flex-col items-center justify-center rounded-3xl lg:mr-12 lg:mb-0 mb-6">
                <h2 className='-mt-6' >Websites created</h2>
                    <h1  className=' text-5xl mt-3 text-purple-800' >{cards_created_this_month}</h1>
                </div>
            </div>
            <div className="w-full h-[330px] overflow-scroll flex flex-col lg:items-center mt-6 border-t border-purple-600">

                {
                    ...
                    <h1 className='text-2xl mt-16 text-purple-600' >No websites created this month</h1>
                    : ''
                }
    ...
    <TabPanel>
        <div className="w-full flex flex-col">
            <div className="w-full  flex-wrap flex items-center justify-center">
                <div className="w-[320px] h-56 border border-purple-600 bg-purple-100 text-purple-800 flex flex-col items-center justify-center rounded-3xl lg:mr-12 lg:mb-0 mb-6">
                    <h2 className='-mt-6' >My earnings</h2>
                    <h1 className='text-5xl mt-3 text-purple-800' >₹{earnings_this_today}</h1>
                </div>
                <div className="w-[320px] h-56 border border-purple-600 bg-purple-100 text-purple-800 flex flex-col items-center justify-center rounded-3xl lg:mr-12 lg:mb-0 mb-6">
                <h2 className='-mt-6' >Websites created</h2>
                    <h1 className='text-5xl mt-3 text-purple-800' >{cards_created_today}</h1>
                </div>
            </div>
            <div className="w-full h-[330px] overflow-scroll flex flex-col lg:items-center mt-6 border-t border-purple-600">

            {
                    ...
                    <h1 className='text-2xl mt-16 text-purple-600' >No website created today</h1>
                    : ''
                }
    ...
    <TabPanel>
        <div className="w-full flex flex-col">
            <div className="w-full  flex-wrap flex items-center justify-center">
                <div className="w-[320px] h-56 border border-purple-600 bg-purple-100 text-purple-800 flex flex-col items-center justify-center rounded-3xl lg:mr-12 lg:mb-0 mb-6">
                    <h2 className='-mt-6' >My Earnings</h2>
                    <h1 className='text-5xl mt-3 text-purple-800' >₹{total_earnings}</h1>
                </div>
                <div className="w-[320px] h-56 border border-purple-600 bg-purple-100 text-purple-800 flex flex-col items-center justify-center rounded-3xl lg:mr-12 lg:mb-0 mb-6">
                <h2 className='-mt-6' >Websites created</h2>
                    <h1 className='text-5xl mt-3 text-purple-800' >{cards_created}</h1>
                </div>
            </div>
            <div className="w-full h-[330px] overflow-scroll flex flex-col lg:items-center mt-6 border-t border-purple-600">

            {
                    ...
                    <h1 className='text-2xl mt-16 text-purple-600' >No cards created</h1>
                    : ''
                }
