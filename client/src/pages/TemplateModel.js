    ...
    <div className="flex justify-center items-center pt-24">
      <div className="lg:w-4/12 w-full ">
        <div
          ...
          className="template-1 flex justify-center bg-no-repeat bg-cover lg:rounded-3xl"
        >
          <div className="card ">
            <span className="absolute top-4 right-4 text-white text-xs font-visita-medium border border-white py-1 px-2 rounded-full">
              Views: 127
            </span>
              ...
              <div className="px-6">
                ...
                >
                  <span className="ml-6 text-lg flex items-center font-visita-medium">
                    <ion-icon name="call"></ion-icon>{" "}
                    <span className="ml-3">+91 9946365417</span>{" "}
                  </span>
                </div>
                <div
                  className={`w-full h-12 border-2 text-white bg-black/70 border-${theme_color}-500 mt-4 flex items-center rounded-full`}
                ...
                >
                  <span className="ml-6 text-lg flex items-center font-visita-medium">
                    <ion-icon name="mail"></ion-icon>{" "}
                    <span className="ml-3">arshadpyaseen@gmail.com</span>{" "}
                  </span>
                </div>
                <div
                ...
                <div className="w-full flex items-center justify-center mt-8">
                  ...
                  >
                    Share<span className="ml-1 text-white text-xl"></span>
        ...
        >
          ...
          >
            ...
            <h1 className="pt-3 font-visita-medium text-green-500 text-xl">
              <span className="mr-2 text-slate-600 line-through">₹99</span>₹29
            </h1>
            <a
            ...
            >
              Enquiry Now<span className="ml-1 text-white text-xl"></span>
            ...
            >
              View Product<span className="ml-1 text-white text-xl"></span>
      ...
      <div
        className={`lg:w-[32.2%] w-full h-14 flex bg-${theme_color}-500 fixed bottom-0 overflow-scroll z-50`}
      >
        <a
          href="#home"
