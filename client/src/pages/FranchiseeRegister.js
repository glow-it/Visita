    ...
    <div className=" bg-white border border-slate-800 rounded-3xl shadow-md px-8 py-16 w-full max-w-md space-y-8 z-50">
      ...
      {/* Password Strength Display */}
        <div  className=" w-full -mt-4 flex items-center justify-center">
          <span id='pass_strength_display' class="bg-red-100 hidden text-red-800 font-visita-medium text-sm rounded-full font-medium px-4 py-1  ">Weak</span> 

          <Tooltip   px='4' bg='black' py='4' color='white' rounded='xl' label='strong password need at least one lowercase letter, one uppercase letter, one digit, one special character, and is at least 8 characters.' placement='right-start'>

          <span id='whatis_strong_pass' className='hidden cursor-pointer ml-1 flex items-center justify-center' > <ion-icon name="help-circle"></ion-icon></span>
