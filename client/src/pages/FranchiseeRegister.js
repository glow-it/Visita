...
<div className="overlays z-10">
    ...
    <div className="flex min-h-full items-center justify-center lg:pt-44 pt-24 px-4 sm:px-6 lg:px-8">
      ...
      <form className="mt-8 space-y-6" action="#" method="POST">
        ...
        <div className="-space-y-px rounded-md shadow-sm">
          <div>
            ...
            <input
              ...
              className="relative block transition-all font-visita-medium w-full appearance-none rounded-full border border-gray-300 px-6 mt-3 py-3 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-lg"
        ...
        <div>
          <button
            ...
            className="group relative flex w-full justify-center rounded-full border border-transparent bg-blue-600 py-3 px-4 text-lg font-visita-bold text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all"
          >
            Register
          </button>
        </div>
