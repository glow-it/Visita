            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div
                    align="center"
                    className="MsoNormal w-full flex justify-center font-medium"
                    data-custom-class="subtitle"
                    style={{ textAlign: "left", lineHeight: "1.5" }}
                  >
                    <span
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <bdt className="question">
                      PARAYANGADAN HOUSE VAKKETHODI, MULLAMPARA
                    </bdt>
                    <bdt className="block-component" />,{" "}
                    <bdt className="question">MANJERI P O Manjeri-kla H.O</bdt>
                    <span
                      style={{
                        fontSize: "11.0pt",
                        lineHeight: "115%",
                    ...
                    , <bdt className="question">Manjeri</bdt>
                  </span>
                </span>
                <span style={{ fontSize: "15px" }}>
                    ...
                    <span style={{ fontSize: "15px" }}>
                      <span data-custom-class="body_text">
                        <span style={{ color: "rgb(89, 89, 89)" }}>
                          ...
                          <bdt className="statement-end-if-in-editor" />
                          <bdt className="block-component" />{" "}
                          <bdt className="question">676121</bdt>
                          <bdt className="statement-end-if-in-editor" />
                        </span>
                      </span>
                    </span>
                ...
                <bdt data-type="body">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <a
                          href="https://visitasmart.com/privacy"
                          target="_blank"
                          data-custom-class="link"
                        >
                          https://visitasmart.com/privacy
                        </a>
                      </bdt>
                    </b>
                    <span
                ...
                <strong>
                  <span style={{ color: "rgb(89, 89, 89)" }}>
                    <strong>
                      <span style={{ fontSize: "15px" }}>
                        <bdt className="block-component" />
                        Phone: <bdt className="question">8592027066</bdt>
                        <bdt className="statement-end-if-in-editor" />
                      </span>
                    </strong>
                  </span>
                  ...
                  <strong>
                    ...
                    >
                      <bdt
                        ...
                        data-type="question"
                      >
                        <strong>team@visitasmart.com</strong>
                      </bdt>
                    </span>
                  </strong>
                </strong>
