...
function ProductsPage() {
  ...
  return (
    ...
    <div class="relative">
        ...
        <input onChange={(e)=> setSeachValue(e.target.value)} type="search" id="default-search" class="block border-t-blue-600 border-t w-full p-4 pl-10 text-sm text-gray-900  " placeholder="Search products..." required />
        ...
        <div class="z-10 bg-white w-full h-screen flex flex-col overflow-scroll px-8">

            {
                ...
                products
                  ...
                  .map((data,index)=> {
                    return(
<div className={`w-full lg:w-[400px] min-h-[450px] ring-2 ring-offset-2 ring-${theme_color}-600 bg-slate-50 rounded-3xl flex overflow-hidden flex-col my-3`}>
