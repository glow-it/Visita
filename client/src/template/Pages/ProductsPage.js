...
<div className="h-16 w-full  bg-white z-50 flex items-center justify-center">
    ...
    <div class="relative">
        ...
        <input autoComplete='off' onChange={(e)=> setSeachValue(e.target.value)}  id="default-search" class="block pl-14 pr-16 border font-medium  w-full p-4  text-sm text-gray-900  rounded-full" placeholder="Search products..." required />
