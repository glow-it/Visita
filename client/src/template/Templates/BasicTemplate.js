      ...
      <div className={`${preview ? "w-full" : "lg:w-4/12"}  w-full `}>
        ...
        >
          ...
          <div className="card relative">
            ...
            <Link
              to={`/${cardDatas && cardDatas.clean_name}/products`}
              className={`z-50 absolute top-6  left-4 text-white text-2xl font-medium  py-2 px-2 flex items-center justify-center rounded-full bg-${theme_color}-600 `}
            >
                      ...
                      if (navigator.share) {
                        navigator
                          .share({
                            ...
                            url:
                              "https://visitasmart.com/" + cardDatas.clean_name,
                          })
                          .then(() => {
        ...
        >
              ...
              .map((data, index) => {
                return (
                  <div
                    z
                    div
                    className={`w-full pb-12 mb-8 px-8 shadow-xl border-2 border-${theme_color}-600  rounded-3xl flex flex-col items-center relative ${
                      index == 0 ? "mt-20" : "mt-2"
                    }`}
                  >
                    <img
          ...
          {products && products.length != 0 ? (
            <div className="w-full h-32  flex items-center justify-center">
              <button
                onClick={() => {
                  navigate("/" + cardDatas.clean_name + "/products");
                }}
